...
public class Reserva {
    ...
    public Reserva(String nombreResponsable, String apellidoResponsable, int dniResponsable, Date fecha,

                           DatosTarjeta tarjeta, Cancha canchaReservada, float total) {
